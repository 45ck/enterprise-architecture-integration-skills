---
name: "application-landscape-mapper"
pack: "enterprise-architecture-integration-pack"
purpose: "Describe the surrounding application landscape so ownership, overlap, integration points, and replacement candidates are explicit."
inputs: ["target system", "adjacent applications", "teams and ownership", "known interfaces"]
outputs: ["application landscape map", "ownership map", "overlap/replacement notes", "integration hot spots"]
handoffs: ["service-contract-designer", "rpc-vs-message-pattern-selector", "orchestration-vs-choreography-reviewer"]
---
# application-landscape-mapper

## Purpose
Describe the surrounding application landscape so ownership, overlap, integration points, and replacement candidates are explicit.
