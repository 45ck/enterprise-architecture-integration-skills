---
name: "public-private-hybrid-cloud-selector"
pack: "enterprise-architecture-integration-pack"
purpose: "Select between public, private, and hybrid cloud options with explicit attention to compliance, integration, latency, and operational realities."
inputs: ["workload constraints", "compliance needs", "network/integration context", "operational model"]
outputs: ["cloud hosting recommendation", "rationale", "risk/tradeoff summary", "operational implications"]
handoffs: ["environment-topology-planner", "container-vs-vm-advisor", "ci-cd-readiness-checker"]
---
# public-private-hybrid-cloud-selector

## Purpose
Select between public, private, and hybrid cloud options with explicit attention to compliance, integration, latency, and operational realities.
