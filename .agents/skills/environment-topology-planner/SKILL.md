---
name: "environment-topology-planner"
pack: "enterprise-architecture-integration-pack"
purpose: "Plan enterprise environment topology across dev, test, staging, UAT, production, support, and disaster recovery needs."
inputs: ["release model", "environment needs", "test strategy", "ops/support constraints"]
outputs: ["environment topology plan", "promotion path", "environment risks", "release implications"]
handoffs: ["container-vs-vm-advisor", "ci-cd-readiness-checker", "public-private-hybrid-cloud-selector"]
---
