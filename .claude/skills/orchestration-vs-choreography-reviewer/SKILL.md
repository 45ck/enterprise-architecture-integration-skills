---
name: "orchestration-vs-choreography-reviewer"
pack: "enterprise-architecture-integration-pack"
purpose: "Review whether orchestration, choreography, or a mixed coordination model best suits cross-system workflows."
inputs: ["cross-system workflow", "participants", "state ownership", "failure handling needs"]
outputs: ["coordination model recommendation", "workflow risks", "ownership implications", "follow-up design tasks"]
handoffs: ["service-contract-designer", "publish-subscribe-designer", "environment-topology-planner"]
---
# orchestration-vs-choreography-reviewer

## Purpose
Review whether orchestration, choreography, or a mixed coordination model best suits cross-system workflows.
