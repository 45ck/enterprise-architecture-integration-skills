---
name: "rpc-vs-message-pattern-selector"
pack: "enterprise-architecture-integration-pack"
purpose: "Decide whether synchronous RPC, asynchronous messaging, or a hybrid pattern best fits the integration context."
inputs: ["interaction needs", "latency tolerance", "failure mode tolerance", "consistency expectations"]
outputs: ["pattern recommendation", "decision rationale", "tradeoff summary", "integration follow-up list"]
handoffs: ["service-contract-designer", "orchestration-vs-choreography-reviewer", "loose-coupling-checker"]
---
# rpc-vs-message-pattern-selector

## Purpose
Decide whether synchronous RPC, asynchronous messaging, or a hybrid pattern best fits the integration context.
