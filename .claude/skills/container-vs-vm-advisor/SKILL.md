---
name: "container-vs-vm-advisor"
pack: "enterprise-architecture-integration-pack"
purpose: "Advise when containers, virtual machines, or a mixed platform model are the safer enterprise choice."
inputs: ["workload characteristics", "ops model", "security/isolation needs", "platform constraints"]
outputs: ["platform recommendation", "justification", "security/ops caveats", "migration or rollout notes"]
handoffs: ["environment-topology-planner", "ci-cd-readiness-checker", "public-private-hybrid-cloud-selector"]
---
# container-vs-vm-advisor

## Purpose
Advise when containers, virtual machines, or a mixed platform model are the safer enterprise choice.
